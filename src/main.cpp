...
const string strMessageMagic = "Vortex Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight > 0 && nHeight <= 10) {
        nSubsidy = 600000000 * COIN; // premine
    }
    else if (nHeight > 10 && nHeight <= 10000) {
        nSubsidy = 1000 * COIN; 
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 9000 && pindexBest->nHeight+1 <= 86400) {
        nSubsidy = 10000 * COIN;
    }
    else if (pindexBest->nHeight+1 > 86400 && pindexBest->nHeight+1 <= 172800)  {
        nSubsidy = 9000 * COIN;
    }
    else if (pindexBest->nHeight+1 > 86400 && pindexBest->nHeight+1 <= 259200)  {
        nSubsidy = 8100 * COIN;
    }
    else if (pindexBest->nHeight+1 > 259200 && pindexBest->nHeight+1 <= 345600) {
        nSubsidy = 7290 * COIN;
    }
    else if (pindexBest->nHeight+1 > 345600 && pindexBest->nHeight+1 <= 432000) {
        nSubsidy = 6560 * COIN;
    }
    else if (pindexBest->nHeight+1 > 432000 && pindexBest->nHeight+1 <= 518400) {
        nSubsidy = 5900 * COIN;
    }
	else if (pindexBest->nHeight+1 > 518400 && pindexBest->nHeight+1 <= 604800) {
        nSubsidy = 5300 * COIN;
    }
    else if (pindexBest->nHeight+1 > 604800 && pindexBest->nHeight+1 <= 691200) {
        nSubsidy = 4770 * COIN;
    }
    else if (pindexBest->nHeight+1 > 691200 && pindexBest->nHeight+1 <= 777600) {
        nSubsidy = 4290 * COIN;
    }
    else  {
        nSubsidy = 3860 * COIN;
