...
private slots:
    ...
    QString BuyVRX(QString OrderType, double Quantity, double Rate);
    QString SellVRX(QString OrderType, double Quantity, double Rate);
